...
const Input = ({ data , touched , error , value, onChange, onBlur} :PassedProps ) => {
    ...
    <input className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500 "  value={value} onChange={onChange} onBlur={onBlur} type={type}  placeholder={label} name={name}/>
